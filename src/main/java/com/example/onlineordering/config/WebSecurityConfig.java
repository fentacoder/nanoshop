...
import com.example.onlineordering.daoimpl.UserDetailsServiceImpl;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().and().formLogin()//
               ...
               // .successHandler( authenticationSuccessHandler )
                ...
                .and().logout().invalidateHttpSession(true).logoutUrl("/logout").logoutSuccessUrl("/logoutSuccessful");
